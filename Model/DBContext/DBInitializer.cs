namespace Fitness.Model.DBContext
{
    ...
    public class DBInitializer: DropCreateDatabaseIfModelChanges<FitnessDB>//CreateDatabaseIfNotExists<FitnessDB>
    {
        ...
        private void AddClients(FitnessDB context)
        {
            ...
            context.Clients.Add(new Client { Id = 1001, BarCode = "614704024060", FirstName = "Alison", LastName = "Ramirez", PhoneNumber = "0757446374", Sex="F", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1002, BarCode = "594483537929", FirstName = "Tracy", LastName = "Berry", PhoneNumber = "0729085485", Sex = "F", InsertDate = new System.DateTime(2019, 3, 25), InserterId = 4, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1003, BarCode = "760763000069", FirstName = "Toni", LastName = "Sharp", PhoneNumber = "0702794292", Sex = "M", InsertDate = new System.DateTime(2019, 3, 26), InserterId = 5, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1004, BarCode = "698497100539", FirstName = "Darrel", LastName = "Hammond", PhoneNumber = "0720057803", Sex = "M", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1005, BarCode = "375514164514", FirstName = "Ruby", LastName = "Brooks", PhoneNumber = "0754253354", Sex = "F", InsertDate = new System.DateTime(2019, 3, 25), InserterId = 4, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1006, BarCode = "618252276755", FirstName = "Ashley", LastName = "Cook", PhoneNumber = "0777278351", Sex = "F", InsertDate = new System.DateTime(2019, 3, 26), InserterId = 5, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1007, BarCode = "242243662974", FirstName = "Julia", LastName = "Murphy", PhoneNumber = "0798824569", Sex = "F", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1008, BarCode = "275326489211", FirstName = "Lois", LastName = "Allen", PhoneNumber = "0747489794", Sex = "M", InsertDate = new System.DateTime(2019, 3, 25), InserterId = 4, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1009, BarCode = "148890289309", FirstName = "Christopher", LastName = "Taylor", PhoneNumber = "0733675341", Sex = "M", InsertDate = new System.DateTime(2019, 3, 26), InserterId = 5, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1010, BarCode = "682675671728", FirstName = "Mark", LastName = "Gonzales", PhoneNumber = "0711059158", Sex = "M", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1011, BarCode = "136751805332", FirstName = "Diana", LastName = "Richardson", PhoneNumber = "0733019204", Sex = "F", InsertDate = new System.DateTime(2019, 3, 25), InserterId = 4, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1012, BarCode = "348882585558", FirstName = "Donald", LastName = "Lewis", PhoneNumber = "0776043954", Sex = "M", InsertDate = new System.DateTime(2019, 3, 26), InserterId = 5, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1013, BarCode = "382597335798", FirstName = "Nicholas", LastName = "Watson", PhoneNumber = "0735739765", Sex = "M", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1014, BarCode = "553671675421", FirstName = "Heather", LastName = "Jackson", PhoneNumber = "0759244536", Sex = "F", InsertDate = new System.DateTime(2019, 3, 25), InserterId = 4, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1015, BarCode = "661996133847", FirstName = "Fred", LastName = "Clark", PhoneNumber = "0738130360", Sex = "M", InsertDate = new System.DateTime(2019, 3, 26), InserterId = 5, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1016, BarCode = "213346907014", FirstName = "Anna", LastName = "Martinez", PhoneNumber = "0721604475", Sex = "F", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1017, BarCode = "169076375984", FirstName = "Stephanie", LastName = "Flores", PhoneNumber = "0774711310", Sex = "F", InsertDate = new System.DateTime(2019, 3, 25), InserterId = 4, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1018, BarCode = "379914837074", FirstName = "Kathryn", LastName = "Price", PhoneNumber = "0701463487", Sex = "F", InsertDate = new System.DateTime(2019, 3, 26), InserterId = 5, IsDeleted = false });
            context.Clients.Add(new Client { Id = 1019, BarCode = "957018351346", FirstName = "Sandra", LastName = "Perry", PhoneNumber = "0748528709", Sex = "F", InsertDate = new System.DateTime(2019, 3, 24), InserterId = 3, IsDeleted = false });
